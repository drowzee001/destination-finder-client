...
export const getLocations = () => (dispatch, getState) => {
  ...
  axios
    .get(`https://destination-finder.donovanrowzee.net/locations/${user_id}`)
    .then((res) =>
      dispatch({
        type: GET_LOCATIONS,
        payload: res.data,
...
export const getLocation = (place_id) => (dispatch, getState) => {
  ...
  const user_id = getState().auth.user.id;
  axios
    .get(`https://destination-finder.donovanrowzee.net/locations/${user_id}/${place_id}`)
    .then((res) => {
      dispatch({
        type: GET_LOCATION,
        payload: res.data,
...
export const addLocation = (place_id, image, name) => (dispatch, getState) => {
  ...
  axios
    .post("https://destination-finder.donovanrowzee.net/locations", location, config)
    .then((res) =>
      dispatch({
        type: ADD_LOCATION,
        payload: res.data,
...
export const deleteLocation = (id) => (dispatch, getState) => {
  ...
  axios
    .delete(`https://destination-finder.donovanrowzee.net/locations/${id}`, config)
    .then((res) => {
      dispatch({
